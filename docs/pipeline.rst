...
are set in `jenkins/branches/demo/default.env`. To modify your app's settings copy this file to be named after your demo branch
(e.g `cp jenkins/branches/demo/default.env jenkins/branches/demo/pmac-l10n.env` for the branch `demo/pmac-l10n.env`).
